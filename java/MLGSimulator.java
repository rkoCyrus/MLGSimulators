//It's not nesscery to use maven etc, these also enough to pack as jar file
...
public class MLGSimulator {
    ...
    private boolean doGame() {
        ...
        for (int i = 1; i < 16; i++) {
            ...
            out.print("\n\tCurrently you have " + doritos.size() + " Dorito(s) and " + dew.size() + " " + "litre(s) of Mountain Dew.");
            out.print("\n\tHow many Doritos do you want to buy? Doritos cost " + Dorito.COST + " MLG " + "Points " + "and earn " + Dorito.PTS_TURN + " MLG Points per turn!\n");
            ...
            out.print("\n\tHow many litres of Mountain Dew do you want to buy? Dew costs " + MtnDew.COST + " MLG Points per litre and earns " + MtnDew.PTS_TURN + " per turn.");
        ...
        out.print("\n\tThe game has ended with you scoring " + mlgPoints + ", " + doritos.size() + " " + "Dorito(s) and " + dew.size() + " litre(s) of Mountain Dew.");
